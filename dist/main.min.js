...
(function () {
  ...
  var placemarks = [{
    ...
    ballonContent: ['<div class="map__balloon">', '<img class="map__burger-img" src="img/" alt="Burger"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: ул.Литералов, д. 19', '</div>']
  }, {
    latitude: 59.94,
    longitude: 30.25,
    hintContent: '<div class="map__hint"> Малый проспект В 0, д. 64 </div>',
    ballonContent: ['<div class="map__balloon">', '<img class="map__burger-img" src="img/" alt="Burger"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: Малый проспект В 0, д. 64', '</div>']
  }, {
    latitude: 59.93,
    longitude: 30.34,
    hintContent: '<div class="map__hint"> наб. реки Фонтанки, д. 56 </div>',
    ballonContent: ['<div class="map__balloon">', '<img class="map__burger-img" src="img/" alt="Burger"/>', 'Самые вкусные бургеры у нас! Заходите по адресу: наб. реки Фонтанки, д. 56', '</div>']
  }, {
    latitude: 59.91,
    longitude: 30.32,
    hintContent: '<div class="map__hint"> наб. реки Фонтанки, д. 56 </div>',
