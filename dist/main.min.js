...
(function () {
  var verticalAcco = function verticalAcco() {
    var calculateWidth = function calculateWidth() {
      ...
      var titles = document.querySelectorAll('.carte__title');
      var title = document.querySelector('.carte__title');
      var titlesWidth = parseFloat(getComputedStyle(title).width);
      var reqWidth = windowWidth - titlesWidth * titles.length;
