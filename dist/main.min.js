...
var durationControl;
var soundControl;
var intervalId; // документ полностью загружен
...
function playStop() {
  ...
  $(".video__player-img").toggleClass("video__player-img--active"); // присваиваем ползунку продолжительности максимальное значение равное продолжительности нашего видео (в секундах)
